...
mask = ((data['signal1'].shift(1) == 100) & (data['signal1'] == 100)) | ((data['signal1'].shift(1) == -100) & (data['signal1'] == -100))
data.loc[mask, 'signal1'] = 0
mask = ((data['signal2'].shift(1) == 100) & (data['signal2'] == 100)) | ((data['signal2'].shift(1) == -100) & (data['signal2'] == -100))
data.loc[mask, 'signal2'] = 0
mask = ((data['signal3'].shift(1) == 100) & (data['signal3'] == 100)) | ((data['signal3'].shift(1) == -100) & (data['signal3'] == -100))
data.loc[mask, 'signal3'] = 0
mask = ((data['signal4'].shift(1) == 100) & (data['signal4'] == 100)) | ((data['signal4'].shift(1) == -100) & (data['signal4'] == -100))
data.loc[mask, 'signal4'] = 0
mask = ((data['signal5'].shift(1) == 100) & (data['signal5'] == 100)) | ((data['signal5'].shift(1) == -100) & (data['signal5'] == -100))
data.loc[mask, 'signal5'] = 0
mask = ((data['signal6'].shift(1) == 100) & (data['signal6'] == 100)) | ((data['signal6'].shift(1) == -100) & (data['signal6'] == -100))
data.loc[mask, 'signal6'] = 0

print(data[['signal1', 'signal2', 'signal3', 'signal4', 'signal5', 'signal6']])
