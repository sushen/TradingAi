...
class Connection:
    ...
    def connect_worksheet(worksheet_name="tracker"):
        gc = gspread.service_account('C:\\Users\\babyagiuser\\PycharmProjects\\TradingAiDevlopment\\googlesheet\\trade-tracker-372004-ad983b16bb21.json')
        ...
        # gc = gspread.service_account('C:\\Users\\zihad\\PycharmProjects\\TradingAiDevelopment\\googlesheet\\trade-tracker-372004-ad983b16bb21.json')
